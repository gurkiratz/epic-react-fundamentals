...
- To add styles in JSX elements, style properties are enclosed in `{{ }}`.
- I think that was a lot for deep understanding, most of it we'll not be using
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=singh.gurkirat2707%40gmail.com).
