...
- Learnt basic JSX syntax
- JSX elements can receive props
- props can be used by spread operator easily like `<div {...props} />`
- there are a few subtle differences between JSX and HTML. One such difference
  ...
  than `class`!
- 📜 You can learn the differences between JSX and HTML syntax from the React
  docs here:
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=singh.gurkirat2707%40gmail.com).
